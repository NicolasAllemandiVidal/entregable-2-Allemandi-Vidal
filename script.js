...
function crearHome(){
    ...
    addVideo.setAttribute("src", "./Files/test.mp4");
...
function createButton(){
    ...
    buttonCrear.addEventListener("click", function crearPerfil(nombre, clave) {
        ...
        logo.appendChild(confirm);
        confirm.innerText = "Usuario Creado con exito";
        confirm.classList.add("message");
        setTimeout(function(){
            confirm.remove();
        },3000);
    });
    ...
    buttonsLogin.addEventListener("click", function login(usuario, clave) {
        ...
        localStorage.setItem('alumnoUsuario', usuario);
            ...
            let incorrect = document.createElement("h2");
            logo.appendChild(incorrect);
            incorrect.innerText = "Usuario o Contraseña incorrecto";
            incorrect.classList.add("message");
            setTimeout(function(){
                incorrect.remove();
            },3000);
    }};
